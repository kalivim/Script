...
#   Author: Kionf <www.kionf.com>                                 #
#   Intro:  https://www.kionf.com                                 #
#=================================================================#
...
function pre_install(){
    ...
    read -p "(Default password: www.kionf.com):" shadowsockspwd
    [ -z "$shadowsockspwd" ] && shadowsockspwd="www.kionf.com"
    echo
    echo "---------------------------"
...
function download_files(){
    if [ "$OS" == 'CentOS' ]; then
        ...
        if ! wget --no-check-certificate https://raw.githubusercontent.com/kalivim/Linux_shell/master/shadowsocks/shadowsocks -O /etc/init.d/shadowsocks; then
            echo "Failed to download shadowsocks chkconfig file!"
            exit 1
        fi
    else
        if ! wget --no-check-certificate https://raw.githubusercontent.com/kalivim/Linux_shell/master/shadowsocks/shadowsocks-debian -O /etc/init.d/shadowsocks; then
            echo "Failed to download shadowsocks chkconfig file!"
            exit 1
        fi
    fi
...
function install_ss(){
    ...
    if [ -f /usr/bin/pip ]; then
        ...
        if [ -f /usr/bin/ssserver ] || [ -f /usr/local/bin/ssserver ]; then
            ...
            echo
            echo "Shadowsocks install failed! Please visit http://www.kionf.com and contact."
            exit 1
        fi
        clear
        echo
        ...
        echo
        echo "Welcome to visit:http://www.kionf.com"
        echo "Enjoy it!"
        echo
        exit 0
    else
